    ...
    <footer className="bg-forest-900 text-green-100 mt-auto" role="contentinfo" aria-label="Site footer">
      ...
      <div className="container-main py-10">
          ...
          <div>
            ...
            <ul className="space-y-2 font-body text-sm" role="list">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-green-300 hover:text-white transition-colors duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white rounded">{link.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          <div>
            ...
            <address className="not-italic font-body text-sm space-y-2 text-green-200">
              <div className="flex items-start gap-2">
                ...
                <span>PO Box 301 / 7 Birch Point Road<br />Princeton, ME 04668</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-earth-400 flex-shrink-0" aria-hidden="true" />
                <a href="tel:+12077963351" className="hover:text-white transition-colors duration-150">(207) 796-3351</a>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-earth-400 flex-shrink-0" aria-hidden="true" />
                <a href="tel:+12077963301" className="hover:text-white transition-colors duration-150">(207) 796-3301</a>
              </div>
            </address>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t border-forest-700 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs font-body text-green-400">
          ...
          <a href="https://www.passamaquoddy.com/" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-1 text-green-300 hover:text-white transition-colors duration-150">

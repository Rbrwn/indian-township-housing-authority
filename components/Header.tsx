...
export default function Header() {
  ...
  return (
    <header className={`sticky top-0 z-50 bg-forest-800 text-white transition-shadow duration-200 ${scrolled ? 'shadow-lg' : 'shadow-md'}`} role="banner">
      ...
      <div className="container-main">
        <div className="flex items-center justify-between py-3">
          <Link href="/" className="flex items-center gap-3 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white rounded-lg p-1" aria-label="Indian Township Housing Authority — Home">
            ...
            <div>
              <div className="font-heading font-bold text-sm sm:text-base leading-tight">Indian Township</div>
              <div className="font-heading font-bold text-xs sm:text-sm text-green-300 leading-tight">Housing Authority</div>
          ...
          <button className="lg:hidden p-2 rounded-md text-green-100 hover:bg-forest-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
            onClick={() => setMenuOpen(!menuOpen)} aria-expanded={menuOpen} aria-controls="mobile-menu"
